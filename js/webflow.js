...
Webflow.require('ix').init([
  {"slug":"zoom","name":"Zoom","value":{"style":{"opacity":0,"scaleX":0.88,"scaleY":0.88,"scaleZ":1},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":"1000ms"},{"opacity":1,"transition":"transform 3600ms ease-out-quart 0, opacity 900ms ease-out-quart 0","scaleX":1,"scaleY":1,"scaleZ":1}],"stepsB":[]}]}},
  {"slug":"delayed-appearance","name":"Delayed Appearance","value":{"style":{"opacity":0},"triggers":[{"type":"load","stepsA":[{"wait":"3600ms"},{"opacity":1,"transition":"opacity 450ms ease 0"}],"stepsB":[]}]}}
]);
